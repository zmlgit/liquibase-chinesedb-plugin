...
public class KingBaseDatabase extends AbstractJdbcDatabase {
    ...
    public boolean isSystemObject(DatabaseObject example) {
        ...
        if ((example instanceof Table) && (example.getSchema() != null) && (("SYS_CATALOG".equals(example.getSchema().getName())) || ("SYS_TOAST".equals(example.getSchema().getName())))) {
            return true;
        }
