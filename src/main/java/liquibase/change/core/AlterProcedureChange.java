...
@DatabaseChange(name = "alterProcedure", description = "修改存储过程", priority = ChangeMetaData.PRIORITY_DEFAULT)
public class AlterProcedureChange extends AbstractChange {
    ...
    protected SqlStatement[] generateStatements(String logicText, String endDelimiter, Database database) {
        AlterProcedureStatement statement = new AlterProcedureStatement(getCatalogName(), getSchemaName(), getProcedureName(), endDelimiter);
